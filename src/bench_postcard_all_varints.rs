...
use postcard_all_varints as postcard;
    ...
    T: Serialize + for<'de> Deserialize<'de>,
{
    ...
    let mut group = c.benchmark_group(format!("{}/postcard-all-varints", name));
    ...
    crate::bench_size(name, "postcard-all-varints", deserialize_buffer.as_slice());
